  ...
  const fetch = useCallback(async () => {
    ...
    for (const v of visitsRes.data || []) {
      items.push({
        ...
        prospect:    v.prospect?.name    || '',
        time:        fmtTime(v.created_at),
        timeStr:     new Date(v.created_at).toLocaleTimeString('es-MX', { hour: '2-digit', minute: '2-digit', hour12: false }),
    ...
    for (const q of quotesRes.data || []) {
      ...
      items.push({
        ...
        prospect:    q.prospect?.name    || '',
        time:        fmtTime(q.created_at),
        timeStr:     new Date(q.created_at).toLocaleTimeString('es-MX', { hour: '2-digit', minute: '2-digit', hour12: false }),
    ...
    for (const a of activitiesRes.data || []) {
      items.push({
        ...
        timeStr:     new Date(a.created_at).toLocaleTimeString('es-MX', { hour: '2-digit', minute: '2-digit', hour12: false }),
